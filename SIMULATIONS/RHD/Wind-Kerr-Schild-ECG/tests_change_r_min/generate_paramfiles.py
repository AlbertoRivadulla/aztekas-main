...
outputdirectory = ./results_ECG/K_{K_str}/vinf_{vinf_str}/eps_{eps_val}_rmin_{r_min_factor}_racc/
outputfile      = wind_

% RESTART SIMULATION (1 -> true, 0 -> false)
restart_simulation = 0
restartfile = ./results_ECG/K_{K_str}/vinf_{vinf_str}/eps_{eps_val}_rmin_{r_min_factor}_racc/wind_30.dat
...
# Multiplicative factors to compute r_min
r_min_factors = [ 0.4, 0.5, 0.6 ]

# Directory for the files
paramfiles_directory = './tests_change_r_min'
if len(sys.argv) > 1:
