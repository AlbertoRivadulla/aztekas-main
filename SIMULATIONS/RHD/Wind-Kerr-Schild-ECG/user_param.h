...
// Arrays with the values of the functions in the metric for each value of r in the grid
double* alpha_vals;
double* beta_r_con_vals;
double* beta_r_cov_vals;
double* gamma_rr_con_vals;
double* gamma_rr_cov_vals;
// Same for their derivatives with respect to r
double* der_r_alpha_vals;
double* der_r_beta_con_vals;
double* der_r_gamma_rr_cov_vals;
