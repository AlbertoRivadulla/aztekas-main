...
outputdirectory = ./results_ECG/K_{K_str}/vinf_{vinf_str}/eps_{eps_val}_N_{Nx1}/
outputfile      = wind_

% RESTART SIMULATION (1 -> true, 0 -> false)
restart_simulation = 0
restartfile = ./results_ECG/K_{K_str}/vinf_{vinf_str}/eps_{eps_val}_N_{Nx1}/wind_30.dat
...
# N_r     = 200
# N_theta = 200
# N_grid_vals = [ 200, 250, 300, 400 ]
N_grid_vals = [ 100, 200, 300, 400 ]
...
paramfiles_directory = './tests_change_grid'
if len(sys.argv) > 1:
...
paramfiles_base_name = paramfiles_directory + 'wind_ECG_{epsilon}_vinf_{vinf}_N_{N_grid}.param'
